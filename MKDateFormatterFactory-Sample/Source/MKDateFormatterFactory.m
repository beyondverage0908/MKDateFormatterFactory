...
@implementation MKDateFormatterFactory
...
+ (MKDateFormatterFactory *)sharedFactory {
    ...
    static MKDateFormatterFactory *sharedInstance = nil;
    
    dispatch_once(&onceToken, ^{
        sharedInstance = [[MKDateFormatterFactory alloc] init];
    });
